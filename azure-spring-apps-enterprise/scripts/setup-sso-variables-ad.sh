...
export CLIENT_ID=$(cat ../resources/json/sso.json | jq -r '.appId')
export CLIENT_SECRET=$(cat ../resources/json/sso.json | jq -r '.password')
export TENANT_ID=$(cat ../resources/json/sso.json | jq -r '.tenant')
